...
public class CreerVehicule extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CreerVehicule frame = new CreerVehicule();
	...
	public CreerVehicule() {
		...
		contentPane.add(tfMarque, gbc_textField);
	...
	public void creer(Vehicule vehicule) {
		int res = 0;
